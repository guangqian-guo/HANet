...
class IDAUp(nn.Module):
    ...
    def __init__(self, o, channels, up_f):
        ...
        for i in range(1, len(channels)):
            ...
            # proj = DeformConv(c, o)
            # node = DeformConv(o, o)
            proj = ConvModule(c, o, kernel_size=(3,3),stride=1, padding=1,
                              norm_cfg=dict(type='BN'))
            node = ConvModule(o, o, kernel_size=(3,3),stride=1, padding=1,
                              norm_cfg=dict(type='BN'))
...
class FinalIDAUp(nn.Module):
    ...
    def __init__(self, o, channels):
        ...
        for i in range(len(channels)):
            ...
            # proj = DeformConv(channels[i], o)
            proj = ConvModule(channels[i], o, kernel_size=(3,3),stride=1, padding=1,
                              norm_cfg=dict(type='BN'))
                 
            up = nn.ConvTranspose2d(o, o, 4, stride=2, 
...
class DLASegCenter(nn.Module):
    ...
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel,
        ...
        self.final_up = FinalIDAUp(64, channels[self.first_level:]
                                    )
