...
class ResNet_Trans(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_Trans, self).__init__(init_cfg)
        ...
        self.depths = [2,2,2,2]  #[3,4,6,3]

        self.resnet_channels = [256, 512, 1024, 2048]
        self.window_size = [24, 16, 12, 6]
        ...
        for i in range(num_stages):
            depth_conv = nn.Conv2d(in_channels=self.embed_dims[i], out_channels= self.resnet_channels[i],
                                   kernel_size=1,stride=1)

            # setattr(self, f"transformer_block{i+1}", transformer_block)
            setattr(self, f"depth_conv{i+1}", depth_conv)
    ...
    def _init_weights(self):
        ...
        model_weight_path = '/home/ubuntub/.cache/torch/checkpoints/pvt_tiny.pth'
    ...
    def forward(self, x):
        ...
        for i, layer_name in enumerate(self.res_layers):
            ...
            x = res_layer(x)+trans_attention_after_conv
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_Trans, self).train(mode)
        self._freeze_stages()
