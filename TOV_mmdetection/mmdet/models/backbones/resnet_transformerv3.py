...
class ResNet_Transv3(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_Transv3, self).__init__(init_cfg)
    ...
    def _init_weights(self):
        ...
        model_weight_path = '/home/ubuntu/.cache/torch/hub/checkpoints/pvt_tiny.pth'
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_Transv3, self).train(mode)
        self._freeze_stages()
