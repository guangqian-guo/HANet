...
STANDARD_COLORS = [
 'green', (255,140,0),  (135,206,235), 'magenta', (60,179,113), (69, 255, 0), 'cyan', (255,99,71), (255,20,147)
]
# 几种颜色， added by guo
STANDARD_COLORS2 = [(0, 254, 122), (239, 37, 144), (4, 133, 188), (252, 253, 1), (129, 254, 212), (0, 100, 255), (90, 129, 250), (229, 150, 98)]
...
def imshow_det_bboxes(img,
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        #不同类别生成不同颜色的box, by guo
        bbox_color = color_val_matplotlib(STANDARD_COLORS2[label%8]) # 只有8种颜色，循环使用
        ...
        # commented by guo, if you want to add text on bbox, cancel it.
        ax.text(
            bbox_int[0],
            bbox_int[1],
            f'{label_text}',
            ...
            # color=text_color,
            color = bbox_color,  #和box的颜色相同, by guo
            fontsize=font_size,
